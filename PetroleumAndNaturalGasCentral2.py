...
#2(T2)
class PetroleumAndNaturalGasCentral2(OCSpider):
    name = "PetroleumAndNaturalGasCentral2"
    ...
    start_urls_names = {
        "https://mopng.gov.in/en/exp-and-prod/other-notifications":''
    }
    ...
    def get_articles(self, response) -> list:
        datetime_strs = response.xpath("//span[@class='date-display-single']//text()").getall()
        article_links = response.xpath("//td[@class='views-field views-field-php']//a//@href").getall()
        title_links = response.xpath(".//td[@class='views-field views-field-title']//text()").getall()
