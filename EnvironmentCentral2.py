...
#2(T2)
class EnvironmentCentral2(OCSpider):
    name = "EnvironmentCentral2"
    ...
    start_urls_names = {
        "https://moef.gov.in/dissemination-of-completed-project":''
    }
    ...
    def get_articles(self, response) -> list:
        article_links = response.xpath("//div[@class='table-responsivebox']//a//@href").getall()
